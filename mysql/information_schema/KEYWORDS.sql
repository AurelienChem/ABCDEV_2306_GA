...
-- Listage de la structure de table information_schema. KEYWORDS
...
-- Listage des données de la table information_schema.KEYWORDS : 0 rows
/*!40000 ALTER TABLE `KEYWORDS` DISABLE KEYS */;
INSERT INTO `KEYWORDS` (`WORD`, `RESERVED`) VALUES
	('ACCESSIBLE', 1),
	('ACCOUNT', 0),
	('ACTION', 0),
	('ACTIVE', 0),
