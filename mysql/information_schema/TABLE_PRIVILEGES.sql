...
-- Listage de la structure de table information_schema. TABLE_PRIVILEGES
...
-- Listage des données de la table information_schema.TABLE_PRIVILEGES : 0 rows
/*!40000 ALTER TABLE `TABLE_PRIVILEGES` DISABLE KEYS */;
INSERT INTO `TABLE_PRIVILEGES` (`GRANTEE`, `TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `PRIVILEGE_TYPE`, `IS_GRANTABLE`) VALUES
