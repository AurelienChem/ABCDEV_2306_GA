...
-- Listage de la structure de table information_schema. INNODB_FT_INDEX_CACHE
...
-- Listage des données de la table information_schema.INNODB_FT_INDEX_CACHE : 0 rows
