...
-- Listage de la structure de table information_schema. INNODB_CMP_PER_INDEX_RESET
...
-- Listage des données de la table information_schema.INNODB_CMP_PER_INDEX_RESET : 0 rows
