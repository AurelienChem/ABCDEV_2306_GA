...
-- Listage de la structure de table information_schema. INNODB_TEMP_TABLE_INFO
...
-- Listage des données de la table information_schema.INNODB_TEMP_TABLE_INFO : 0 rows
