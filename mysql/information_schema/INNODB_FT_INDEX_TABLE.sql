...
-- Listage de la structure de table information_schema. INNODB_FT_INDEX_TABLE
...
-- Listage des données de la table information_schema.INNODB_FT_INDEX_TABLE : 0 rows
