...
-- Listage de la structure de table information_schema. COLLATION_CHARACTER_SET_APPLICABILITY
...
-- Listage des données de la table information_schema.COLLATION_CHARACTER_SET_APPLICABILITY : 0 rows
