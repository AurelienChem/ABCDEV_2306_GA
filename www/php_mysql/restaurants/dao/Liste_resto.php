...
class Liste_resto {
    ...
    public function affichageAll() : array {
        ...
        $liste = $listeStatement->fetchAll(); /* READ du CRUD global */
    ...
    public function chercherResto(int $id) : array {
        ...
        $pdoStatement->execute(); /* READ du CRUD avec un paramètres en particulier */
       
        
        while($row = $pdoStatement->fetch() ) /* tant qu'il trouve des lignes */  {
