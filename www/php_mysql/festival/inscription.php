...
<body>
    ...
    <form action="" method="post" class="form-example">
        ...
        <select name="departement_user" id="dept-select">

            <?php $data_dept = $objConnectionAll2->searchAll();
            
            for ($i = 0; $i < count($data_dept); $i++) {
            echo "<option value=".$data_dept[$i]["id_dep"].">".$data_dept[$i]["Name"]."</option>";
            }
            ?> 
